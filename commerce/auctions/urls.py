...
urlpatterns = [
    ...
    path("product_detail/close/<listing_id>", views.closeAuction, name="closeAuction"),
    ...
    path("product_detail/bid/<listing_id>", views.bid, name="bid"),
    path("product_detail/comment/<listing_id>", views.comment, name="comment"),
